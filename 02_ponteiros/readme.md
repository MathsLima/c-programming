...
```
1. Função que receba um vetor de inteiros, o tamanho do vetor e um valor a ser procurado. A função procura o valor no vetor, caso encontre retorna a posição (índice) no vetor. Caso não encontre, retorna -1.
```
```
