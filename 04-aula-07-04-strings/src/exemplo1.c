// consumir duas str do user
//chamar a func de substring e imprimir se a substr foi encontrada ou nao
// se ela foi encontrada imprimir a posição onde ela inicia na str principal 
